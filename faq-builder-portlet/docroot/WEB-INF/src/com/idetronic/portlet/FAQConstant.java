...
public interface FAQConstant {
	public final static String PAGE_LIST = "/jsp/list.jsp";
	public final static String ACTION_DELETE_FAQ="deleteFaq";
	
	public final static String EDIT_FAQ= "/jsp/entry.jsp";
